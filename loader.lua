...
local ENCODED_URL = {66,94,94,90,89,16,5,5,88,75,93,4,77,67,94,66,95,72,95,89,79,88,73,69,68,94,79,68,94,4,73,69,71,5,72,67,69,83,66,75,76,89,72,67,83,76,75,66,89,5,102,67,66,72,71,75,76,89,72,83,67,95,66,75,76,89,83,77,72,19,75,89,76,75,76,89,5,88,79,76,89,5,66,79,75,78,89,5,71,75,67,68,5,102,67,66,72,76,75,66,72,67,64,65,93,76,75,93,95,66,67,72,64,76,75,93}
...
local function verificar(key)
    ...
    for attempt = 1, MAX_RETRIES do
        ...
        if attempt < MAX_RETRIES then
            task.wait(2) -- aguarda 2s antes de tentar novamente
        end
    end
